...
const speechTranscripts = {
    ...
    "km-KH": "សូមស្វាគមន៍មកកាន់ការធ្វើបទបង្ហាញស្តីពីការគ្រោងបើកដំណើរការ HUOKAING THARA ISP។ ការអភិវឌ្ឍន៍ត្រូវបានបែងចែកជា ៥ ដំណាក់កាល៖ ដំណាក់កាលទី១ មជ្ឈមណ្ឌលទិន្នន័យ NOC, ដំណាក់កាលទី២ បណ្តាញ Fiber Backbone, ដំណាក់កាលទី៣ បណ្តាញ FTTH, ដំណាក់កាលទី៤ ប្រព័ន្ធ AI, និងដំណាក់កាលទី៥ កិច្ចសហប្រតិបត្តិការជាមួយរដ្ឋាភិបាល និងអន្តរជាតិ MPTC, TRC, ITU ក្នុងថវិកា ៣៥ ប៊ីលានដុល្លារ ដោយស្វ័យពលកម្មឥតត្រូវការទុនវិនិយោគពីខាងក្រៅ។",
...
function announcePhase5() {
    ...
    if ('speechSynthesis' in window) {
        ...
        currentUtterance.onstart = () => {
            ...
            logTelemetry("Executing Phase 5 Gov & Int'l Cooperation Announcement ($35B Self-Funded)...");
        };
